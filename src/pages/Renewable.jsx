...
const CLD_FOLDER = "hillstar/renewable";
...
const ADMIN_PIN =
  ...
  "0809130732800";
const LS_ADMIN_ON_KEY = "hillstar.renewable.adminOn";
...
export default function Renewable() {
  ...
  const baseVideos = useMemo(
    () => [
      { src: "/tours/civic.mp4", label: "Renewable Tour #1" },
      { src: "/tours/paragon.mp4", label: "Renewable Tour #2" },
      { src: "/tours/lekki.mp4", label: "Renewable Tour #3" },
    ],
    []
  );
  ...
  return (
    <>
      ...
      <HeroStrip title="Renewable Energy" />

      <Section
        title="What Renewable Energy Means at Hillstar"
        ...
        >
          ...
          >
            ...
            <div style={{ opacity: 0.8, fontSize: 14 }}>
              Enter the admin PIN to manage renewable videos.
            </div>
            <input
              type="password"
              autoFocus
        ...
        >
          ...
          <div>
            ...
            <input
              ...
              placeholder="e.g. Civic Solar Walkthrough"
            />
          </div>
          <div>
