...
const CLD_FOLDER = "hillstar/telecom";
...
const ADMIN_PIN =
  ...
  "0809130732800";
const LS_ADMIN_ON_KEY = "hillstar.telecom.adminOn";
...
export default function Telecom() {
  ...
  const baseVideos = useMemo(
    () => [
      { src: "/tours/civic.mp4", label: "Telecom Tour #1" },
      { src: "/tours/paragon.mp4", label: "Telecom Tour #2" },
      { src: "/tours/lekki.mp4", label: "Telecom Tour #3" },
    ],
    []
  );
  ...
  return (
    <>
      ...
      <HeroStrip title="Telecom & Technology" />
      <Section
        title="What Telecom Means at Hillstar"
          ...
          >
            {videos.map((v, i) => (
              <VideoPlayer
                key={`${v.src}-${i}`}
                src={v.src}
                label={v.label || `Telecom Tour #${i + 1}`}
              />
            ))}
          </div>
        )}
        ...
        >
          ...
          >
            ...
            <div style={{ opacity: 0.8, fontSize: 14 }}>
              Enter the admin PIN to manage telecom videos.
            </div>
            <input
              type="password"
              autoFocus
        ...
        <form onSubmit={submit} style={{ display: "grid", gap: 10, marginTop: 10 }}>
          ...
          <div>
            ...
            <input
              ...
              placeholder="e.g. FTTx Rollout Walkthrough"
            />
          </div>
          <div>
